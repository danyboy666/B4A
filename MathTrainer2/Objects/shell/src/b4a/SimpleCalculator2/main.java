...
public class main implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("main"), "b4a.SimpleCalculator2.main");
	}
...
public static RemoteObject _lblresultat = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _nombre2 = RemoteObject.createImmutable(0);
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"btn0",main.mostCurrent._btn0,"btnAction",main.mostCurrent._btnaction,"lblCommentaire",main.mostCurrent._lblcommentaire,"lblNombre1",main.mostCurrent._lblnombre1,"lblNombre2",main.mostCurrent._lblnombre2,"lblResultat",main.mostCurrent._lblresultat,"lblSigneMath",main.mostCurrent._lblsignemath,"Nombre1",main._nombre1,"Nombre2",main._nombre2};
}
}