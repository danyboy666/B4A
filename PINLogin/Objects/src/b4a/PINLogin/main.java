...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.PINLogin", "b4a.PINLogin.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.PINLogin", "b4a.PINLogin.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.PINLogin.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public ResumableSub_btnEvent_Click(b4a.PINLogin.main parent) {
this.parent = parent;
}
b4a.PINLogin.main parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 64;BA.debugLine="Private btn As Button";
_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 65;BA.debugLine="count = count + 1";
parent._count = (int) (parent._count+1);
 //BA.debugLineNum = 67;BA.debugLine="btn = Sender";
_btn.setObject((android.widget.Button)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
 //BA.debugLineNum = 69;BA.debugLine="Select count";
if (true) break;
...
//C
this.state = 22;
 //BA.debugLineNum = 71;BA.debugLine="pnlKey1.Color = Colors.Red";
parent.mostCurrent._pnlkey1.setColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 72;BA.debugLine="temp = temp & btn.Tag";
parent.mostCurrent._temp = parent.mostCurrent._temp+BA.ObjectToString(_btn.getTag());
 //BA.debugLineNum = 73;BA.debugLine="edtPWD.Text = temp";
parent.mostCurrent._edtpwd.setText(BA.ObjectToCharSequence(parent.mostCurrent._temp));
 if (true) break;

case 5:
//C
this.state = 22;
 //BA.debugLineNum = 75;BA.debugLine="pnlKey2.Color = Colors.Red";
parent.mostCurrent._pnlkey2.setColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 76;BA.debugLine="temp = temp & btn.Tag";
parent.mostCurrent._temp = parent.mostCurrent._temp+BA.ObjectToString(_btn.getTag());
 //BA.debugLineNum = 77;BA.debugLine="edtPWD.Text = edtPWD.Text & btn.Tag";
parent.mostCurrent._edtpwd.setText(BA.ObjectToCharSequence(parent.mostCurrent._edtpwd.getText()+BA.ObjectToString(_btn.getTag())));
 if (true) break;

case 7:
//C
this.state = 22;
 //BA.debugLineNum = 79;BA.debugLine="pnlKey3.Color = Colors.Red";
parent.mostCurrent._pnlkey3.setColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 80;BA.debugLine="temp = temp & btn.Tag";
parent.mostCurrent._temp = parent.mostCurrent._temp+BA.ObjectToString(_btn.getTag());
 //BA.debugLineNum = 81;BA.debugLine="edtPWD.Text = edtPWD.Text & btn.Tag";
parent.mostCurrent._edtpwd.setText(BA.ObjectToCharSequence(parent.mostCurrent._edtpwd.getText()+BA.ObjectToString(_btn.getTag())));
 if (true) break;
...
//C
this.state = 10;
 //BA.debugLineNum = 83;BA.debugLine="pnlKey4.Color = Colors.Red";
parent.mostCurrent._pnlkey4.setColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 84;BA.debugLine="temp = temp & btn.Tag";
parent.mostCurrent._temp = parent.mostCurrent._temp+BA.ObjectToString(_btn.getTag());
 //BA.debugLineNum = 85;BA.debugLine="edtPWD.Text = edtPWD.Text & btn.Tag";
parent.mostCurrent._edtpwd.setText(BA.ObjectToCharSequence(parent.mostCurrent._edtpwd.getText()+BA.ObjectToString(_btn.getTag())));
 //BA.debugLineNum = 86;BA.debugLine="Sleep(500)";
...
this.state = 10;
;
 //BA.debugLineNum = 87;BA.debugLine="If temp = master Then";
if (true) break;
...
//C
this.state = 21;
 //BA.debugLineNum = 88;BA.debugLine="clearScreen";
_clearscreen();
 //BA.debugLineNum = 89;BA.debugLine="Activity.Finish";
parent.mostCurrent._activity.Finish();
 //BA.debugLineNum = 90;BA.debugLine="StartActivity(Me)";
...
//C
this.state = 15;
 //BA.debugLineNum = 92;BA.debugLine="attempt = attempt + 1";
parent._attempt = (int) (parent._attempt+1);
 //BA.debugLineNum = 93;BA.debugLine="If attempt = 3 Then";
if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 96;BA.debugLine="clearScreen";
_clearscreen();
 if (true) break;
...
public static String  _clearscreen() throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Sub clearScreen()";
 //BA.debugLineNum = 104;BA.debugLine="pnlKey1.Color = Colors.White";
mostCurrent._pnlkey1.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 105;BA.debugLine="pnlKey2.Color = Colors.White";
mostCurrent._pnlkey2.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 106;BA.debugLine="pnlKey3.Color = Colors.White";
mostCurrent._pnlkey3.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 107;BA.debugLine="pnlKey4.Color = Colors.White";
mostCurrent._pnlkey4.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 108;BA.debugLine="edtPWD.Text = \"\"";
mostCurrent._edtpwd.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 109;BA.debugLine="temp = \"\"";
mostCurrent._temp = "";
 //BA.debugLineNum = 110;BA.debugLine="count = 0";
_count = (int) (0);
 //BA.debugLineNum = 111;BA.debugLine="End Sub";
return "";
}
public static String  _edtpwd_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub edtPWD_TextChanged (Old As String, New As Stri";
